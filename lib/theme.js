...
import { buttonsb } from './theme/buttonsb';
...
export default {
  ...
  fonts: {
    body: 'Inter, -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu',
    heading: '"FTPolarBold", -apple-system, system-ui, BlinkMacSystemFont, "Segoe UI", Roboto, Ubuntu',
    monospace: 'SF Mono-Light, monospace'
  },
  ...
  menubuttons: {
    ...
    default: {
      ...
      headerItem: {
        fontSize: 3,
        m: 1,
        '&[data-selected]': { backgroundColor: 'onSurfaceAlt', borderRadius: 'round', color: 'text' }
      }
    }
  },
