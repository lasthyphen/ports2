  ...
  return (
    <PrimaryLayout sx={{ maxWidth: 'dashboard' }}>
      <HeadComponent
        ...
        description={`See the results of the DGC proposals passed so far ${
          ...
          <InternalLink href={'/executive'} title="View executive proposals">
            <Button variant="mutedOutline" mb={2}>
              <Flex sx={{ alignItems: 'center', whiteSpace: 'nowrap' }}>
                ...
                Back to {bpi === 0 ? 'All' : 'Mandate'} Proposals
              </Flex>
            </Button>
          </InternalLink>
          <Card sx={{ p: [0, 0] }}>
        ...
        <Stack gap={3} sx={{ mb: [5, 0] }}>
          {account && bpi !== 0 && (
            <Box>
              ...
              <Card variant="compact" sx={{padding: '18px 24px 20px', fontSize: '14px', color: '#787a9b'}}>
                <Text sx={{ fontSize: 3 }}>
                      ...
                      >
                        ...
                        <Box sx={{ textAlign: 'right' }}>
                          <Text color="onSecondary">
                            {supporter.percent}% ({new BigNumberJS(supporter.deposits).toFormat(2)} HAL)
                          </Text>
                        </Box>
                      </Flex>
                    ))}
