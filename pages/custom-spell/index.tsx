  ...
  return (
    <PrimaryLayout sx={{ maxWidth: [null, null, null, 'page', 'dashboard'] }}>
      ...
      <Text as="p" sx={{ mt: 3, color: 'onSecondary' }}>
        This page can be used to vote on custom executive mandates by manually entering the mandate address.
        Fetching mandate details for a custom executive mandate might return some empty values in case they are
        not available to non core team members.
      </Text>
        ...
        <>
          ...
          <Card>
            <Flex sx={{ flexDirection: 'column' }}>
              {spellData === null && (
                <Flex sx={{ mt: 3 }}>
                  <Text>No method details found</Text>
                </Flex>
              )}
