        ...
        <SidebarLayout>
          <Box>
            {filteredPolls.length > 0 ? (
              <Stack>
                <div>
                  <Flex sx={{ alignItems: 'center', justifyContent: 'space-between', my: 3, position: 'relative' }}>
                ...
                {showHistorical ? (
                  ...
                  <Button
                    ...
                    sx={{ mb: 5, py: 3, display: historicalPolls.length > 0 ? 'none' : 'none' }}
                  >
...
export const getStaticProps: GetStaticProps = async () => {
  const { polls, tags } = await fetchPollingPageData(SupportedNetworks.DIJETS);
