...
export interface PotInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "Pie" | "cage" | "chi" | "deny" | "drip" | "dsr" | "exit" | "file(bytes32,uint256)" | "file(bytes32,address)" | "join" | "live" | "pie" | "rely" | "rho" | "vat" | "vow" | "wards"): FunctionFragment;
...
export interface Pot extends BaseContract {
    ...
    functions: {
        ...
        exit(wad: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "file(bytes32,uint256)"(what: PromiseOrValue<BytesLike>, data: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "file(bytes32,address)"(what: PromiseOrValue<BytesLike>, addr: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        join(wad: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        "file(bytes32,address)"(what: PromiseOrValue<BytesLike>, addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
