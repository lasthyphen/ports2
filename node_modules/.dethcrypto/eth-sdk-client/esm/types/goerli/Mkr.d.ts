...
export interface MkrInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "allowance" | "approve(address,uint256)" | "approve(address)" | "authority" | "balanceOf" | "burn(uint256)" | "burn(address,uint256)" | "decimals" | "mint(address,uint256)" | "mint(uint256)" | "move" | "name" | "owner" | "pull" | "push" | "setAuthority" | "setName" | "setOwner" | "start" | "stop" | "stopped" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;
...
export declare type StartEvent = TypedEvent<[], StartEventObject>;
export declare type StartEventFilter = TypedEventFilter<StartEvent>;
export interface StopEventObject {
}
export declare type StopEvent = TypedEvent<[], StopEventObject>;
