...
export interface DssSpellInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "action" | "cast" | "description" | "done" | "eta" | "expiration" | "log" | "nextCastTime" | "officeHours" | "pause" | "schedule" | "sig" | "tag"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "nextCastTime", values?: undefined): string;
    encodeFunctionData(functionFragment: "officeHours", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "nextCastTime", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "officeHours", data: BytesLike): Result;
