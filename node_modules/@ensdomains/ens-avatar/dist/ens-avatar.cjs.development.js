...
var createDOMPurify = _interopDefault(require('dompurify'));
var multiformats = require('multiformats');
var isSVG = _interopDefault(require('is-svg'));
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              contract = new contracts.Contract(contractAddress, abi, provider);
              _context.next = 4;
    ...
    var _getMetadata = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(provider, ownerAddress, contractAddress, tokenID) {
      ...
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              contract = new contracts.Contract(contractAddress, abi$1, provider);
              _context.next = 3;
...
exports.AvatarResolver = AvatarResolver;
exports.UnsupportedNamespace = UnsupportedNamespace;
exports.specs = specs;
exports.utils = utils;
//# sourceMappingURL=ens-avatar.cjs.development.js.map
