...
async function main() {
  try {
    ...
    //poll tags
    const urlTags =
      'https://raw.githubusercontent.com/lasthyphen/dgc-polls/master/governance/polls/meta/tags.json';
    ...
    const urlDelegateTags =
      'https://raw.githubusercontent.com/lasthyphen/dgc-polls/master/governance/delegates/meta/tags.json';
