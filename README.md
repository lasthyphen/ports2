...
<p>Dijets Governance Portal</p>

</h1>

This is the repo containing the code for the [Dijets Governance Portal](https://vote.makerdao.com). The Dijets Governance Portal is an open-source interface for governance of the Maker protocol. </br>Copyright [Dai Foundation](https://daifoundation.org/) 2022.
...
- [GitHub](https://github.com/lasthyphen/dgc-polls/tree/master/governance) for storing markdown related to [polls](https://github.com/lasthyphen/dgc-polls/tree/master/governance/polls), [executives](https://github.com/lasthyphen/dgc-polls/tree/master/governance/votes), and [recognized delegates](https://github.com/lasthyphen/dgc-polls/tree/master/governance/delegates)
