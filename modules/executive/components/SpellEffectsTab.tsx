          ...
          {expanded && (
            <Box sx={{ mt: 3 }}>
              <Text as="p" variant="secondary">
                This hash allows for manually verifying that the method belongs to the correct Mandate
                Proposal. It can be reproduced by hashing the raw markdown text of this Mandate Proposal.
                The hash, the URL to the raw markdown text, and the correct hashing algorithm are all
                registered on the blockchain in the method smart contract.
              </Text>
              <Box sx={{ mt: 3 }}>
                <ExternalLink
                  href="https://core-council.dijets.io/"
                  title="Learn more about the mandate votes"
                >
                  <Text sx={{ color: 'accentBlue', ':hover': { color: 'accentBlueEmphasis' } }}>
                    Learn more about auditing Mandates
          ...
          {spellData?.officeHours && (
            <Flex mb={3}>
              ...
              <Box>
                ...
                <Text as="p" variant="secondary">
                  Method will only be executed Monday through Friday between 14:00 and 21:00 UTC
                </Text>
              </Box>
            </Flex>
          )}
