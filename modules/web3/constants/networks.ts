...
export const CHAIN_INFO: ChainInfo = {
  [SupportedChainId.DIJETS]: {
    blockExplorerUrl: 'utility-explorer.swedencentral.cloudapp.azure.com',
    blockExplorerName: 'Blockscout',
    chainId: SupportedChainId.DIJETS,
    label: 'Dijets',
    type: 'normal',
    network: SupportedNetworks.DIJETS,
    defaultRpc: NodeProviders.DIJETS,
    spockUrl: DIJETS_SPOCK_URL,
    rpcs: {
      [NodeProviders.DIJETS]: 'https://dijets.ukwest.cloudapp.azure.com:443/ext/bc/C/rpc',
    }
  },
...
export const DEFAULT_NETWORK = CHAIN_INFO[SupportedChainId.DIJETS];
...
const url = 'https://utility-explorer.swedencentral.cloudapp.azure.com/api/v1/gas-price-oracle';
...
export const AVG_BLOCKS_PER_DAY = 1000;

export const GASNOW_ENDPOINT = 'https://utility-explorer.swedencentral.cloudapp.azure.com/api/v1/gas-price-oracle';
export const GASNOW_URL = 'https://utility-explorer.swedencentral.cloudapp.azure.com';
