...
export const resources: LandingResource[] = [
  ...
  {
    title: 'DGC Portal Guide',
    url: 'https://core-council.dijets.io/docs/reference',
    category: ResourceCategory.GOVERNANCE,
    bg: ResourceBackground.GOVERNANCE,
    color: ResourceColor.GOVERNANCE,
    logo: '/assets/resource_icon_2.svg',
    summary:
      'Documentation on the Maker protocol & MakerDAO processes, written for HAL holders that actively participate in governance.'
  },
  {
