  ...
  const renderTooltip = item => {
    ...
    return (
      <Box>
        ...
        {monthMKR && <Text as="p">{commify(parseInt(monthMKR.lockTotal).toFixed(0))} HAL</Text>}
      </Box>
    );
  };

  const formatLegend = () => <span sx={{ color: 'onSurface', fontSize: '14px' }}>HAL Locked in Mandates</span>;
