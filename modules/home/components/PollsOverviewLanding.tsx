...
export const PollsOverviewLanding = ({ activePolls, allPolls }: Props): JSX.Element => {
  ...
  return (
    <Flex sx={{ flexDirection: 'column' }}>
      <Flex sx={{ justifyContent: 'space-between', alignItems: 'center', mb: 3, mt: 3 }}>
        <Text sx={{ textAlign: 'center', fontWeight: '800', fontSize: '15px', textTransform: 'uppercase'  }}>{hasActivePolls ? 'Active Polls' : 'Recent Polls'}</Text>
