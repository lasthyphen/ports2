...
export default function InformationParticipateMakerGovernance(): React.ReactElement {
  ...
  return (
      <Box sx={{ mt: 3, backgroundImage: 'url(/assets/circles.jpeg)', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
        <Box sx={{ p: 3, height: '100%' }}>
          <Flex sx={{ justifyContent: 'space-between', mb: 3, height: '100%', alignItems: 'center' }}>
            <Box sx={{ mr: 2, flex: 1 }}>
              <Heading as="h2">How to participate in Dijets Governance</Heading>
            </Box>
            <Box>
              <ExternalLink
