  ...
  const getVotedOption = () => {
    ...
    return (
      <Text>
        ...
        with {formatValue(comment.comment.voterWeight, undefined, undefined, true, true)} HAL
      </Text>
    );
  };
  ...
  return (
    <Box>
      <CommentItem
        ...
        // twitterUrl={`https://twitter.com/intent/tweet?text=${getTwitterMessage()}&url=${`https://vote.dijets.io/polling/${poll.slug}#comments?network=${network}`}`}
      />
    </Box>
  );
}
