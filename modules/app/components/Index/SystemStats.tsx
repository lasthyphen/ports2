...
export default function SystemStatsSidebar({
  ...
  const statsMap = {
    ...
    'mkr needed to pass': key => {
      ...
      return (
        <Flex key={key} sx={{ justifyContent: 'space-between', flexDirection: 'row' }}>
          <Text sx={{ fontSize: 3, color: 'textSecondary' }}>HAL on Governing Proposal</Text>
          <Text variant="h2" sx={{ fontSize: 3 }}>
            {mkrOnHat ? (
    ...
    'savings rate': key => {
      ...
      return (
        <Flex key={key} sx={{ justifyContent: 'space-between', flexDirection: 'row' }}>
          <Text sx={{ fontSize: 3, color: 'textSecondary' }}>CAPs Acquired</Text>
          <Text variant="h2" sx={{ fontSize: 3 }}>
            {daiSavingsRate ? (
    ...
    'total dai': key => {
      ...
      return (
        <Flex key={key} sx={{ justifyContent: 'space-between', flexDirection: 'row' }}>
          <Text sx={{ fontSize: 3, color: 'textSecondary' }}>CAPs available</Text>
          <Text variant="h2" sx={{ fontSize: 3 }}>
            {totalDai ? (
