...
const MKRAmount = ({
  ...
  return (
    <Flex sx={{ flexDirection: 'column', alignItems: 'center' }}>
      ...
      <Text variant="heading">Enter the amount of HAL to burn</Text>
      <MKRAmountView setBurnAmount={setBurnAmount} burnAmount={burnAmount} mkrBalance={mkrBalance} />
      {lockedInChief ? (
        <Alert variant="notice">
          You have {formatValue(lockedInChief)} HAL locked in DSChief. Withdraw HAL from DSChief to burn it in
          the ESM.
        </Alert>
      ) : null}
