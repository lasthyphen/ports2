          ...
          {submissionMethod === 'gasless' && (
            <Box>
              <Box p={3}>
                ...
                <Text sx={{ mt: 2 }}>
                  Submit your vote by signing your ballot and sending it to the polling contract on Dijets
                  via our relayer.
                </Text>
            ...
            <Box>
              <Box p={3}>
                ...
                <Flex sx={{ alignItems: 'center', mt: 3 }}>
                  ...
                  <Text sx={{ fontSize: 1, color: 'textSecondary' }}>
                    Voting for DGC Members will soon be free
                  </Text>
                </Flex>
                <Button
                  onClick={() => {
                  ...
                  sx={{ mt: 3, width: '100%' }}
                >
                  Proceed with casting your vote.
                </Button>
                <Box>
                  <Flex sx={{ alignItems: 'center', justifyContent: 'center', mt: 3 }}>
              ...
              <Box p={3}>
                ...
                <Flex sx={{ flexDirection: 'column', mt: 3 }}>
                  <Flex sx={{ justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <ExternalLink href="https://core-council.dijets.io" title="Learn more">
                  ...
                  <Flex sx={{ justifyContent: 'space-between', alignItems: 'center', mt: 2 }}>
                    <Text as="p" variant="secondary" sx={{ fontSize: 1 }}>
                      Address has at least {MIN_MKR_REQUIRED_FOR_GASLESS_VOTING_DISPLAY} HAL of polling weight
                    </Text>
                    <Text>
                      {!precheckData ? (
