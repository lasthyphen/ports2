          ...
          >
            ...
            >
              ...
              >
                  ...
                  <Box>
                    <Box>
                      ...
                      <InternalLink href={`/polling/${poll.slug}`} title="View poll details">
                        <CardTitle title={poll.title} dataTestId="poll-overview-card-poll-title" styles={{fontSize: '16px', mt: 2, letterSpacing: '0.02em', fontWeight: 'bold', fontFamily: 'Uber Move Text'}} />
                      </InternalLink>
                    </Box>
                    <InternalLink href={`/polling/${poll.slug}`} title="View poll details">
                ...
                {bpi > 0 && (
                  <Flex mt={1} sx={{ gap: 2, alignItems: 'center', flexWrap: 'wrap' }}>
                    <Box>
                      <ErrorBoundary componentName="Countdown Timer">
                        <CountdownTimer endText="Poll ended" endDate={poll.endDate} />
                      </ErrorBoundary>
                    </Box>
                    <Flex sx={{ display: 'flex', gridTemplateColumns: '1fr', justifyItems: ['stretch', 'center'], gap: 2, flexWrap: 'wrap' }}>
                      {hasPollComments && (
