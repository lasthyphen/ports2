...
The Dijets Governance Facilitator has placed a Governance Poll into the [voting system](https://vote.makerdao.com/polling) on behalf of the Dijets Governance Community. The community can use this poll to express support or opposition for an **ETH-B Vault Type**.
...
To participate in future Governance calls, please [join us](https://github.com/lasthyphen/dgc-polls/tree/master/governance/governance-and-risk-meetings) every Thursday at 16:00 UTC.
