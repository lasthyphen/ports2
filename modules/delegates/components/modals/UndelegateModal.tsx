                ...
                <>
                  {mkrStaked && iouAllowance ? (
                    <InputDelegateMkr
                      ...
                      description="Input the amount of HAL to withdraw from the delegate contract."
                      onChange={setMkrToWithdraw}
                      balance={mkrStaked}
                      buttonLabel="Undelegate HAL"
                      onClick={() => {
                        free(mkrToWithdraw, {
                          mined: () => {
                            mutateTotalStaked();
                    ...
                    <ApprovalContent
                      ...
                      description={
                        'Approve the transfer of IOU tokens to the delegate contract to withdraw your HAL.'
                      }
                    />
                  )}
                </>
