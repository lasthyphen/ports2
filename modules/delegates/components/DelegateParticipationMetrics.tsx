...
export const pollParticipationTooltipLabel = (
  <>
    The percentage of polling votes the DGC Member has participated in. <br />
...
export const executiveParticipationTooltipLabel = (
  <>
    The percentage of executive votes the DGC Member has participated in. <br />
    Updated weekly by the GovAlpha Core Unit. <br />
  </>
);
...
export const communicationTooltipLabel = (
  <>
    The percentage of votes for which the DGC Member has publicly <br />
...
export const participationTooltipLabel = (
  <>
    The percentage of votes the DGC Member has participated in. <br />
    Combines stats for polls and executives. <br />
    Updated weekly by the GovAlpha Core Unit. <br />
  </>
);
