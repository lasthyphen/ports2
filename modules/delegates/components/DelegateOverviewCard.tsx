...
export function DelegateOverviewCard({ delegate }: PropTypes): React.ReactElement {
  ...
  return (
    <Card
      sx={{
        p: 0, 
        backgroundImage: 'url(/assets/baxy.png)',
        backgroundSize: 'contain',
        backgroundRepeat: 'no-repeat',
      }}
      data-testid="delegate-card"
    >
      <Box px={[3, 4]} pb={3} pt={4}>
        <Flex
          sx={{
            ...
            >
              {hasMkrDelegated && (
                <Button
                  ...
                  sx={{ width: '135px', height: ['36px', '38px'], background: '#e06a92', lineHeight: 1, maxWidth: '135px', mr: [2, 2] }}
              ...
              <Flex sx={{ height: '100%' }}>
                ...
                >
                  <Button
                    ...
                    sx={{ borderColor: 'text', color: 'white', whiteSpace: 'nowrap', width:'168px', justifyContent: 'center', mt: 3, ml: '8px' }}
                  >
